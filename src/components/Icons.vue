...
onMounted(async () => {
  ...
  const saveAsComponent = () => {
    ...
    const Q = meta2d.data()
    if (meta2d.store.active && meta2d.store.active.length === 1 && meta2d.store.active[0].name === "combine") {
      let ie = {
        center: Q.center,
        folder: "",
        origin: Q.origin,
      ...
      ie.name = meta2d.store.active[0].description || "\u65B0\u5EFA\u9879\u76EE"
      ;(ie.fullname = ke.fullname), (ie.component = !0)
      const Re = meta2d.canvas.getAllByPens(meta2d.store.active)
      ;(ie.componentDatas = meta2d.toComponent(Re, meta2d.store.data.showChild, !1)), (ie.version = Q.version)
  ...
  const loadSwitch = {
    ...
    data: [
      ...
      },
      {
        ...
        center: {
          x: 1496.2638576489874,
          y: -260.7899542914113,
        },
        children: ["4dd58790", "c5c5e03"],
        events: [
          {
            name: "click",
            action: 6,
        ...
        ex: 1556.2638576489874,
        ey: -200.78995429141122,
        fontSize: 12,
  ...
  const  fuhekaiguan = {
    ...
    },
    {
        "id": "a2d4f",
        "name": "combine",
        "x": 0.24855693545566065,
        "y": 1.9584295903809794e-15,
        "ex": 0.9999999999999982,
        "ey": 1,
    ...
    },
    {
        "id": "1a826a1",
        "name": "combine",
        "x": 365.25148586855005,
        "y": 275.36896489628,
        "ex": 415.27523586855017,
        "ey": 388.24396489628015,
        "width": 50.02375000000014,
        "height": 112.87500000000016,
        "center": {
            "x": 390.26336086855014,
            "y": 331.80646489628003
        },
        "children": [
            "1db21a9",
            "a2d4f"
